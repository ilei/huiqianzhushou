...
class UploadHandlerLogic{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $bucket = 'misc') {
        $this->options = array(
            'bucket' => $bucket,
            'script_url' => $this->get_full_url().'/files/'.$bucket.'/',
    ...
    protected function get_distribute_path($uploaded_file, &$file) {
        ...
        $file->url = $this->options['script_url'] . $relative_path;
