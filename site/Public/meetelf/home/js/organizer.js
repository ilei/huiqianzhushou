define(['jquery', 'messageControl', 'validate', 'MTFCropper', 'langs', 'homeCommon'], function ($, messager) {
    ...
    $("#user_photoV_add").mtfImgUpload('avatar', 'ImgPr_add', '120,120', {
        aspectRatio: 1 / 1,
        minContainerHeight: 200,
        minContainerWidth: 300
    }, upload_callback);
    $("#user_photoV_edit").mtfImgUpload('avatar', 'ImgPr_add', '120,120', {
        aspectRatio: 1 / 1,
        minContainerHeight: 200,
        minContainerWidth: 300
    }, upload_callback);
